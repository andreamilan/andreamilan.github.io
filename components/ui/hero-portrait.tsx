...
export function HeroPortrait() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute -bottom-4 left-4 rounded-full border border-[rgba(246,241,232,0.12)] bg-[rgba(17,15,25,0.82)] px-4 py-2 text-[0.72rem] font-medium uppercase tracking-[0.18em] text-[var(--text-soft)] shadow-[0_14px_40px_rgba(0,0,0,0.18)] backdrop-blur-md">
        Milan, Italy
      </div>
    </motion.div>
  );
